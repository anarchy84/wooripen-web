        ...
        <FadeIn>
          <div className="text-center mb-10 md:mb-14">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 break-keep">
              내 업종에 딱 맞는 <span className="text-primary">솔루션</span>
            </h2>
            <p className="mt-3 text-gray-600 text-sm md:text-base break-keep">
              업종별로 무엇이 꼭 필요하고 어떻게 엮이는지, 우리편이 정리해 드릴게요.
            </p>
          </div>
        </FadeIn>
            ...
            <FadeIn key={tile.slug} delay={i * 80}>
              ...
              >
                ...
                <div className="flex-1 flex flex-col p-5 md:p-6">
                  ...
                  <p className="mt-1 text-sm text-gray-600 break-keep">{tile.tagline}</p>
